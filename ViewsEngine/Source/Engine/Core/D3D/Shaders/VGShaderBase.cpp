...
VGShader::VGShader(ID3D12Device* device, const UINT cbvDescriptorSize, std::wstring filepath)
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 2> VGShader::GetStaticSamplers()
{
...
void VGShader::CompileShader(const D3D_SHADER_MACRO* defines, const std::string& entrypoint, const std::string& target, ID3DBlob** uploader) const
{
    UINT compileFlags = 0;
